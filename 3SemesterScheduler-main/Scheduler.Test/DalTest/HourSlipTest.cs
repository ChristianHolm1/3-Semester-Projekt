...
public class HourSlipTest
{
    ...
    public void Setup()
    {
        ...
        //Insert own name.
        _developerID = new Guid().ToString("N") + "_Bartal";
    ...
    //[Test]
    //public void GetAllUnapprovedHourSlipsFromEmployeeById()
    //{
    //    Console.WriteLine(_hourSlipDAO.GetAllUnapprovedHourSlipsFromEmployeeAsync(184));
    //    //Arrange
    //    //Act
    //    //Assert
    //}

    //Bartal - er ikke sikker på, at det giver mening at opdatere hourslip by userId. User har en et til mange relation til hourslip.
    //Så er det fordi vi skal slette alle hourslips på den pågældende medarbejder. 
    [Test]
    public void UpdateHourslipByUserID()
    {
