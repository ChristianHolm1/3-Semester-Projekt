...
{
    /*                              Attention :) (See as guide but dont follow blindly -- i might have done some mistakes :))
    *      I have followed Microsoft documentation "Best Practice for unit testing"
    *      Practices:
    ...
    *
    *   Sp�rgsm�l til Jakob:
    *   1. M� man gerne bruge metoder som CreateEmployee i en anden test som deleteEmployee hvis den har passed en test (Hvis ikke hvad g�r man s�?)
    *   2. Ser vores test ud til at v�re rigtigt sat op?
    *   3. Hvis arrange ikke skal laves er det ensbetydende med at der er noget galt med vores test? (simpelt?)
    *   4. Hvordan skal man teste for id? --> Create Employee bruger auto generated id.
    *   5. Is it good practice to make a errorMessage?
    *
    *
    */
    ...
    public void Setup()
    {
        ...
        //Write your name
        _developer = developerGuid + "Kenni";
        //Access to database
    ...
    {
        Address address0 = new Address("7800", "Skive", "Lindev�nget", "42");
        Address address1 = new Address("9000", "Aalborg", "Borgmester", "142");
        Address address2 = new Address("3460", "Br�ndby", "K�rsg�rd", "1");
        List<Employee> testData = new List<Employee>
        {
            new Employee {FirstName = _developer, LastName = "Birch", Email = "Kenni@hotmail.com", Password = "StrongPassword123", Role = "Employee", PhoneNumber = "1234", Address = address0},
            new Employee {FirstName = _developer, LastName = "Hansen", Email = "Bartal@hotmail.com", Password = "WeakPassword123", Role = "Manager", PhoneNumber = "2345", Address = address1},
            new Employee {FirstName = _developer, LastName = "James", Email = "Christian@hotmail.com", Password = "MiddlePassword123", Role = "Employee", PhoneNumber = "3465", Address = address2},
